...
//
/// \file XeB2BbRun.cc
/// \brief Implementation of the XeB2BbRun class

#include "XeB2BbRun.hh"
...
void XeB2BbRun::RecordEvent(const G4Event* event)
{
  if ( fCollID_cryst < 0 ) {
   fCollID_cryst 
...
void XeB2BbRun::Merge(const G4Run* aRun)
{
  const XeB2BbRun* localRun = static_cast<const XeB2BbRun*>(aRun);
